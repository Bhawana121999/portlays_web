    ...
    return (
        ...
        <div className="2xl:max-w-[1650px] lg:px-8 2xl:px-4 mx-auto px-4 py-[60px]">
            <div className="text-center relative mb-12">
                ...
                <p className='text-2xl font-medium text-paraColor'>Showcase of athletic journeys and achievements to connect with the global sports community,<br /> boosting visibility, recognition, and career opportunities.</p>
            ...
            <div className="grid grid-cols-4 gap-5">
                {
                    portfolioArr && portfolioArr?.length > 0 && portfolioArr?.map((el, i) => (
                        <div className="col-span-1 rounded-lg overflow-hidden box_shadow" key={i}>
                            ...
                            <div className="bg-red-50 h-[400px] flex flex-row items-center justify-center">
            ...
            <div className="flex flex-row items-center justify-center">
                <button className='text-xl font-semibold text-white bg-secondaryBg rounded-full py-4 px-6 mt-10'>Join as Athlete</button>
            </div>
        </div>
    )
}
